"""F-006 测试夹具：独立库 + dependency_overrides[get_db]，禁止操作运行时业务库。"""
...
AI_ONLY_TITLE = "从未转人工的咨询"
TRANSFER_SUCCESS_MESSAGE = "已提交，等待对接人"
CLOSED_TRANSFER_BODY = {"code": "CONFLICT", "message": "已完结，不能转人工", "data": None}
ALREADY_HUMAN_BODY = {"code": "CONFLICT", "message": "已在人工流程中", "data": None}
NOT_FOUND_BODY = {"code": "NOT_FOUND", "message": "资源不存在", "data": None}
UNAUTHORIZED_BODY = {"code": "UNAUTHORIZED", "message": "未认证", "data": None}
VALIDATION_BODY = {"code": "VALIDATION_ERROR", "message": "参数验证失败", "data": None}
EMPLOYEE_TEXT = "公司 VPN 连不上，提示认证失败。"
SYSTEM_TEXT = "请补充你用的是 Windows 还是 Mac，以及大约从什么时候开始失败。"
QUEUE_ITEM_KEYS = {"id", "title", "status", "requester", "waiting_minutes", "updated_at"}
REQUESTER_KEYS = {"id", "account", "display_name"}
