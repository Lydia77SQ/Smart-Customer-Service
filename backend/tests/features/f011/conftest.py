"""F-011 测试夹具：独立库 + dependency_overrides[get_db]，禁止操作运行时业务库。"""
...
EMPLOYEE_FOLLOW = "还是连不上，请再帮我看一下。"
TARGET_CATEGORY = "IT-网络"
CLOSED_SEND_BODY = {"code": "CONFLICT", "message": "已完结，不能再发送", "data": None}
PENDING_CLOSE_BODY = {"code": "CONFLICT", "message": "未接入不能结单", "data": None}
AI_CLOSE_BODY = {"code": "CONFLICT", "message": "当前状态不可结单", "data": None}
