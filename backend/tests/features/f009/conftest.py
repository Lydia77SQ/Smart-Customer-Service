"""F-009 测试夹具：独立库 + dependency_overrides[get_db]，禁止操作运行时业务库。"""
...
SUGGESTION_KEYS = {"id", "content", "result_type", "created_at"}
